...
@interface FilterViewController () <UITableViewDataSource,UITableViewDelegate,SwitchCellTableViewCellDelegate>
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"SwitchCellTableViewCell" bundle:nil] forCellReuseIdentifier:@"SwitchCellTableViewCell"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SwitchCellTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SwitchCellTableViewCell"];
    if (indexPath.section == kCategorySection) {
